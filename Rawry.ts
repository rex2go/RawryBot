...
export class Rawry {
    ...
    private async setupDatabase() {
        ...
        await query("CREATE TABLE IF NOT EXISTS rawry.user ( id INT(11) AUTO_INCREMENT, streamer_id INT(11) NOT NULL, username VARCHAR(64) NOT NULL, money FLOAT DEFAULT 0.0, message_count INT(11) DEFAULT 0, PRIMARY KEY(id), FOREIGN KEY(id) REFERENCES rawry.streamer(id) );");
